...
if (!class_exists('Pcode_AdminPageFramework_Registry', false)):
    abstract class Pcode_AdminPageFramework_Registry_Base {
    ...
    final class Pcode_AdminPageFramework_Registry extends Pcode_AdminPageFramework_Registry_Base {
        ...
        static public function setUp($sFilePath = __FILE__) {
            ...
            self::$sAutoLoaderPath = isset(self::$aClassFiles['Pcode_AdminPageFramework_RegisterClasses']) ? self::$aClassFiles['Pcode_AdminPageFramework_RegisterClasses'] : '';
            self::$bIsMinifiedVersion = class_exists('Pcode_AdminPageFramework_MinifiedVersionHeader', false);
            self::$bIsDevelopmentVersion = isset(self::$aClassFiles['Pcode_AdminPageFramework_InclusionClassFilesHeader']);
        }
...
if (!class_exists('Pcode_AdminPageFramework_Bootstrap', false)):
    final class Pcode_AdminPageFramework_Bootstrap {
        static private $_bLoaded = false;
        public function __construct($sLibraryPath) {
            if (!$this->_isLoadable()) {
                return;
            }
            Pcode_AdminPageFramework_Registry::setUp($sLibraryPath);
            if (Pcode_AdminPageFramework_Registry::$bIsMinifiedVersion) {
                return;
            }
            $this->_include();
        }
        ...
        private function _include() {
            include (Pcode_AdminPageFramework_Registry::$sAutoLoaderPath);
            new Pcode_AdminPageFramework_RegisterClasses('', array('exclude_class_names' => array('Pcode_AdminPageFramework_MinifiedVersionHeader', 'Pcode_AdminPageFramework_BeautifiedVersionHeader',),), Pcode_AdminPageFramework_Registry::$aClassFiles);
            self::$_bXDebug = isset(self::$_bXDebug) ? self::$_bXDebug : extension_loaded('xdebug');
            if (self::$_bXDebug) {
                new Pcode_AdminPageFramework_Utility;
                new Pcode_AdminPageFramework_WPUtility;
            }
        }
        static private $_bXDebug;
    }
    new Pcode_AdminPageFramework_Bootstrap(__FILE__);
endif;
