...
abstract class Pcode_AdminPageFramework_TaxonomyField_Router extends Pcode_AdminPageFramework_Factory {
...
abstract class Pcode_AdminPageFramework_TaxonomyField_Model extends Pcode_AdminPageFramework_TaxonomyField_Router {
...
abstract class Pcode_AdminPageFramework_TaxonomyField_View extends Pcode_AdminPageFramework_TaxonomyField_Model {
...
abstract class Pcode_AdminPageFramework_TaxonomyField_Controller extends Pcode_AdminPageFramework_TaxonomyField_View {
    public function setUp() {
    }
}
abstract class Pcode_AdminPageFramework_TaxonomyField extends Pcode_AdminPageFramework_TaxonomyField_Controller {
    protected $_sStructureType = 'taxonomy_field';
    function __construct($asTaxonomySlug, $sOptionKey = '', $sCapability = 'manage_options', $sTextDomain = 'presscode') {
