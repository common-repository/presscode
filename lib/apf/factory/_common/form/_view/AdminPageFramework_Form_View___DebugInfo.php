...
class Pcode_AdminPageFramework_Form_View___DebugInfo extends Pcode_AdminPageFramework_FrameworkUtility {
    ...
    public function get() {
        ...
        return "<div class='presscode-info'>" . $this->oMsg->get('debug_info') . ': ' . $this->getFrameworkNameVersion() . "</div>";
    }
