...
class Pcode_AdminPageFramework_Form_View___Generate_FieldTagID extends Pcode_AdminPageFramework_Form_View___Generate_Field_Base {
    public function get() {
...
class Pcode_AdminPageFramework_Form_View___Generate_FieldInputID extends Pcode_AdminPageFramework_Form_View___Generate_FieldTagID {
    public $isIndex = '';
