...
class Pcode_AdminPageFramework_Form_View___Description extends Pcode_AdminPageFramework_FrameworkUtility {
    public $aDescriptions = array();
    public $sClassAttribute = 'presscode-form-element-description';
