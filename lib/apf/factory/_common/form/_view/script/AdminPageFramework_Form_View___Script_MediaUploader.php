...
class Pcode_AdminPageFramework_Form_View___Script_MediaUploader extends Pcode_AdminPageFramework_Form_View___Script_Base {
...
(function ( $ ) {
    ...
    getPcode_AdminPageFrameworkCustomMediaUploaderSelectObject = function() {
