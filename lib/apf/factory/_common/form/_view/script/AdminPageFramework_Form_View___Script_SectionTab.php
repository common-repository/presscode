...
class Pcode_AdminPageFramework_Form_View___Script_SectionTab extends Pcode_AdminPageFramework_Form_View___Script_Base {
...
jQuery( '.presscode-section-tabs-contents' ).createTabs(); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='presscode-section-tabs-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
}
