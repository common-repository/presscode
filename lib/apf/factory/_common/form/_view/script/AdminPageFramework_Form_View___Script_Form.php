...
class Pcode_AdminPageFramework_Form_View___Script_Form extends Pcode_AdminPageFramework_Form_View___Script_Base {
    static public function getScript() {
        return <<<JAVASCRIPTS
( function( $ ) {

    var _removePcode_AdminPageFrameworkLoadingOutputs = function() {

        jQuery( '.presscode-form-loading' ).remove();
        jQuery( '.presscode-form-js-on' )
            .hide()
            .css( 'visibility', 'visible' )
            .fadeIn( 200 )
            .removeClass( '.presscode-form-js-on' );
    ...
    window.onerror = function(){
        ...
        _removePcode_AdminPageFrameworkLoadingOutputs();
