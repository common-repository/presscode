...
class Pcode_AdminPageFramework_Form_View___Script_Widget extends Pcode_AdminPageFramework_Form_View___Script_Base {
    ...
    $( document ).ready( function() {
        ...
        $( document ).ajaxComplete( function( event, XMLHttpRequest, ajaxOptions ) {
            ...
            if( _aRequest.action && ( 'save-widget' === _aRequest.action ) ) {
                ...
                if ( $( _oWidget ).find( '.presscode-sectionset' ).length <= 0 ) { 
                    return; 
                }   
