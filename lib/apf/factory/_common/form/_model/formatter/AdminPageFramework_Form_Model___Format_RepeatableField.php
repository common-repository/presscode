...
class Pcode_AdminPageFramework_Form_Model___Format_RepeatableSection extends Pcode_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct() {
        ...
        $this->_oMsg = $_aParameters[1] ? $_aParameters[1] : Pcode_AdminPageFramework_Message::getInstance();
    }
    public function get() {
...
class Pcode_AdminPageFramework_Form_Model___Format_RepeatableField extends Pcode_AdminPageFramework_Form_Model___Format_RepeatableSection {
    protected function _getDefaultMessage() {
