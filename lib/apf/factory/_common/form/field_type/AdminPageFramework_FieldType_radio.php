...
class Pcode_AdminPageFramework_FieldType_radio extends Pcode_AdminPageFramework_FieldType {
    public $aFieldTypeSlugs = array('radio');
    protected $aDefaultKeys = array('label' => array(), 'attributes' => array(),);
    protected function getStyles() {
        return ".presscode-field input[type='radio'] {margin-right: 0.5em;} .presscode-field-radio .presscode-input-label-container {padding-right: 1em;} .presscode-field-radio .presscode-input-container {display: inline;} .presscode-field-radio .presscode-input-label-string{display: inline; }";
    }
...
jQuery( document ).ready( function(){
    jQuery( 'input[type=radio][data-id=\"{$sInputID}\"]' ).change( function() {
        ...
        jQuery( this ).closest( '.presscode-field' ).find( 'input[type=radio][data-id=\"{$sInputID}\"]' ).attr( 'checked', false );
