...
class Pcode_AdminPageFramework_FieldType_submit extends Pcode_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".presscode-field input[type='submit'] {margin-bottom: 0.5em;}";
    }
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] || '0' === ( string )$aField['label_min_width'] ? "min-width:" . $this->getLengthSanitized($aField['label_min_width']) . ";" : null, 'class' => 'presscode-input-label-container' . ' presscode-input-button-container' . ' presscode-input-container',);
    }
...
class Pcode_AdminPageFramework_FieldType_export extends Pcode_AdminPageFramework_FieldType_submit {
