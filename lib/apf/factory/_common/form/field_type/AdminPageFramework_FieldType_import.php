...
class Pcode_AdminPageFramework_FieldType_import extends Pcode_AdminPageFramework_FieldType_submit {
    ...
    protected function getStyles() {
        return ".presscode-field-import input {margin-right: 0.5em;}.presscode-field-import label,.form-table td fieldset.presscode-fieldset .presscode-field-import label { display: inline; }";
    }
