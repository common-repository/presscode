...
abstract class Pcode_AdminPageFramework_Property_Base extends Pcode_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType) {
        ...
        $this->sTextDomain = empty($sTextDomain) ? 'presscode' : $sTextDomain;
    ...
    private function _setGlobals() {
        if (!isset($GLOBALS['aPcode_AdminPageFramework'])) {
            $GLOBALS['aPcode_AdminPageFramework'] = array('aFieldFlags' => array());
        }
    }
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => Pcode_AdminPageFramework_Registry::NAME, 'sURI' => Pcode_AdminPageFramework_Registry::URI, 'sScriptName' => Pcode_AdminPageFramework_Registry::NAME, 'sLibraryName' => Pcode_AdminPageFramework_Registry::NAME, 'sLibraryURI' => Pcode_AdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => Pcode_AdminPageFramework_Registry::getVersion(), 'sDescription' => Pcode_AdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => Pcode_AdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => Pcode_AdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => Pcode_AdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => Pcode_AdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
    ...
    public function __get($sName) {
        ...
        if ('oUtil' === $sName) {
            $this->oUtil = new Pcode_AdminPageFramework_WPUtility;
            return $this->oUtil;
        }
    }
}
