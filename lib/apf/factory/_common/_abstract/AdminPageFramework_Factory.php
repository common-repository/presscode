...
abstract class Pcode_AdminPageFramework_Factory_Router {
    public $oProp;
    public $oDebug;
    public $oUtil;
    public $oMsg;
    ...
    protected $oHelpPane;
    protected $oLink;
    protected $_aSubClassPrefixes = array('oForm' => 'Pcode_AdminPageFramework_Form_', 'oPageLoadInfo' => 'Pcode_AdminPageFramework_PageLoadInfo_', 'oResource' => 'Pcode_AdminPageFramework_Resource_', 'oHelpPane' => 'Pcode_AdminPageFramework_HelpPane_', 'oLink' => 'Pcode_AdminPageFramework_Link_',);
    private $_aSubClassNames = array('oProp' => null, 'oDebug' => 'Pcode_AdminPageFramework_Debug', 'oUtil' => 'Pcode_AdminPageFramework_FrameworkUtility', 'oMsg' => 'Pcode_AdminPageFramework_Message', 'oForm' => null, 'oPageLoadInfo' => null, 'oResource' => null, 'oHelpPane' => null, 'oLink' => null,);
    ...
    private function _triggerUndefinedMethodWarning($sMethodName) {
        trigger_error(Pcode_AdminPageFramework_Registry::NAME . ': ' . sprintf(__('The method is not defined: %1$s', $this->oProp->sTextDomain), $sMethodName), E_USER_WARNING);
    }
    public function __toString() {
        return Pcode_AdminPageFramework_FrameworkUtility::getObjectInfo($this);
    }
...
abstract class Pcode_AdminPageFramework_Factory_Model extends Pcode_AdminPageFramework_Factory_Router {
    public function __construct($oProp) {
...
abstract class Pcode_AdminPageFramework_Factory_View extends Pcode_AdminPageFramework_Factory_Model {
    public function __construct($oProp) {
        parent::__construct($oProp);
        new Pcode_AdminPageFramework_Factory_View__SettingNotice($this, $this->oProp->sSettingNoticeActionHook);
    }
...
abstract class Pcode_AdminPageFramework_Factory_Controller extends Pcode_AdminPageFramework_Factory_View {
...
abstract class Pcode_AdminPageFramework_Factory extends Pcode_AdminPageFramework_Factory_Controller {
}
