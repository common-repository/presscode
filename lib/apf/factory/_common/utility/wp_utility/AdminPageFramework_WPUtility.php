...
class Pcode_AdminPageFramework_WPUtility_URL extends Pcode_AdminPageFramework_Utility {
    ...
    static public function getQueryAdminURL($aAddingQueries = array(), $aRemovingQueryKeys = array(), $sSubjectURL = '') {
        $_sAdminURL = is_network_admin() ? network_admin_url(Pcode_AdminPageFramework_WPUtility_Page::getPageNow()) : admin_url(Pcode_AdminPageFramework_WPUtility_Page::getPageNow());
    ...
    static public function getSRCFromPath($sFilePath) {
        ...
        $_sRelativePath = Pcode_AdminPageFramework_Utility::getRelativePath(ABSPATH, $sFilePath);
...
class Pcode_AdminPageFramework_WPUtility_HTML extends Pcode_AdminPageFramework_WPUtility_URL {
...
class Pcode_AdminPageFramework_WPUtility_Page extends Pcode_AdminPageFramework_WPUtility_HTML {
...
class Pcode_AdminPageFramework_WPUtility_Hook extends Pcode_AdminPageFramework_WPUtility_Page {
...
class Pcode_AdminPageFramework_WPUtility_File extends Pcode_AdminPageFramework_WPUtility_Hook {
...
class Pcode_AdminPageFramework_WPUtility_Option extends Pcode_AdminPageFramework_WPUtility_File {
...
class Pcode_AdminPageFramework_WPUtility_Meta extends Pcode_AdminPageFramework_WPUtility_Option {
...
class Pcode_AdminPageFramework_WPUtility_SiteInformation extends Pcode_AdminPageFramework_WPUtility_Meta {
...
class Pcode_AdminPageFramework_WPUtility_SystemInformation extends Pcode_AdminPageFramework_WPUtility_SiteInformation {
...
class Pcode_AdminPageFramework_WPUtility extends Pcode_AdminPageFramework_WPUtility_SystemInformation {
