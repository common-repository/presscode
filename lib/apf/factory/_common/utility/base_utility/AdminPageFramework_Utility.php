...
abstract class Pcode_AdminPageFramework_Utility_Deprecated {
    static public function minifyCSS($sCSSRules) {
        Pcode_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getCSSMinified()');
        return Pcode_AdminPageFramework_Utility_String::getCSSMinified($sCSSRules);
    }
    static public function sanitizeLength($sLength, $sUnit = 'px') {
        Pcode_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getLengthSanitized()');
        return Pcode_AdminPageFramework_Utility_String::getLengthSanitized($sLength, $sUnit);
    }
    public static function getCorrespondingArrayValue($vSubject, $sKey, $sDefault = '', $bBlankToDefault = false) {
        Pcode_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getElement()');
        if (!isset($vSubject)) {
            return $sDefault;
        }
    ...
    static public function isAssociativeArray(array $aArray) {
        Pcode_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__);
    ...
    static public function getAttributes(array $aAttributes) {
        Pcode_AdminPageFramework_Utility::showDeprecationNotice(__METHOD__, 'Pcode_AdminPageFramework_WPUtility::getAttributes()');
        $_sQuoteCharactor = "'";
        $_aOutput = array();
...
abstract class Pcode_AdminPageFramework_Utility_VariableType extends Pcode_AdminPageFramework_Utility_Deprecated {
...
abstract class Pcode_AdminPageFramework_Utility_String extends Pcode_AdminPageFramework_Utility_VariableType {
...
abstract class Pcode_AdminPageFramework_Utility_Array extends Pcode_AdminPageFramework_Utility_String {
...
abstract class Pcode_AdminPageFramework_Utility_ArrayGetter extends Pcode_AdminPageFramework_Utility_Array {
...
abstract class Pcode_AdminPageFramework_Utility_ArraySetter extends Pcode_AdminPageFramework_Utility_ArrayGetter {
...
abstract class Pcode_AdminPageFramework_Utility_Path extends Pcode_AdminPageFramework_Utility_ArraySetter {
...
abstract class Pcode_AdminPageFramework_Utility_URL extends Pcode_AdminPageFramework_Utility_Path {
...
abstract class Pcode_AdminPageFramework_Utility_File extends Pcode_AdminPageFramework_Utility_URL {
...
abstract class Pcode_AdminPageFramework_Utility_SystemInformation extends Pcode_AdminPageFramework_Utility_File {
...
abstract class Pcode_AdminPageFramework_Utility_HTMLAttribute extends Pcode_AdminPageFramework_Utility_SystemInformation {
...
class Pcode_AdminPageFramework_Utility extends Pcode_AdminPageFramework_Utility_HTMLAttribute {
