...
class Pcode_AdminPageFramework_AdminNotice extends Pcode_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($sNotice, array $aAttributes = array('class' => 'error'), array $aCallbacks = array()) {
        ...
        $this->aAttributes['class'] = $this->getClassAttribute($this->aAttributes['class'], 'presscode-settings-notice-message', 'presscode-settings-notice-container', 'notice', 'is-dismissible');
        $this->aCallbacks = $aCallbacks + $this->aCallbacks;
        new Pcode_AdminPageFramework_AdminNotice___Script;
        if (!$sNotice) {
            return;
        }
