...
class Pcode_AdminPageFramework_Debug_Base extends Pcode_AdminPageFramework_FrameworkUtility {
...
class Pcode_AdminPageFramework_Debug_Log extends Pcode_AdminPageFramework_Debug_Base {
...
class Pcode_AdminPageFramework_Debug extends Pcode_AdminPageFramework_Debug_Log {
    ...
    static public function dumpArray($asArray, $sFilePath = null) {
        self::showDeprecationNotice('Pcode_AdminPageFramework_Debug::' . __FUNCTION__, 'Pcode_AdminPageFramework_Debug::dump()');
        Pcode_AdminPageFramework_Debug::dump($asArray, $sFilePath);
    }
    static public function getArray($asArray, $sFilePath = null, $bEscape = true) {
        self::showDeprecationNotice('Pcode_AdminPageFramework_Debug::' . __FUNCTION__, 'Pcode_AdminPageFramework_Debug::get()');
        return Pcode_AdminPageFramework_Debug::get($asArray, $sFilePath, $bEscape);
    }
    static public function logArray($asArray, $sFilePath = null) {
        self::showDeprecationNotice('Pcode_AdminPageFramework_Debug::' . __FUNCTION__, 'Pcode_AdminPageFramework_Debug::log()');
        Pcode_AdminPageFramework_Debug::log($asArray, $sFilePath);
    }
    static public function getAsString($mValue) {
        self::showDeprecationNotice('Pcode_AdminPageFramework_Debug::' . __FUNCTION__);
