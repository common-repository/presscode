...
abstract class Pcode_AdminPageFramework_PageMetaBox_Router extends Pcode_AdminPageFramework_MetaBox_View {
...
abstract class Pcode_AdminPageFramework_PageMetaBox_Model extends Pcode_AdminPageFramework_PageMetaBox_Router {
...
abstract class Pcode_AdminPageFramework_PageMetaBox_View extends Pcode_AdminPageFramework_PageMetaBox_Model {
}
abstract class Pcode_AdminPageFramework_PageMetaBox_Controller extends Pcode_AdminPageFramework_PageMetaBox_View {
...
abstract class Pcode_AdminPageFramework_PageMetaBox extends Pcode_AdminPageFramework_PageMetaBox_Controller {
    protected $_sStructureType = 'page_meta_box';
    public function __construct($sMetaBoxID, $sTitle, $asPageSlugs = array(), $sContext = 'normal', $sPriority = 'default', $sCapability = 'manage_options', $sTextDomain = 'presscode') {
