...
abstract class Pcode_AdminPageFramework_UserMeta_Router extends Pcode_AdminPageFramework_Factory {
...
abstract class Pcode_AdminPageFramework_UserMeta_Model extends Pcode_AdminPageFramework_UserMeta_Router {
    public function _replyToGetSavedFormData() {
        $_iUserID = isset($GLOBALS['profileuser']->ID) ? $GLOBALS['profileuser']->ID : 0;
        $_oMetaData = new Pcode_AdminPageFramework_UserMeta_Model___UserMeta($_iUserID, $this->oForm->aFieldsets);
...
abstract class Pcode_AdminPageFramework_UserMeta_View extends Pcode_AdminPageFramework_UserMeta_Model {
...
abstract class Pcode_AdminPageFramework_UserMeta_Controller extends Pcode_AdminPageFramework_UserMeta_View {
...
abstract class Pcode_AdminPageFramework_UserMeta extends Pcode_AdminPageFramework_UserMeta_Controller {
    protected $_sStructureType = 'user_meta';
    public function __construct($sCapability = 'read', $sTextDomain = 'presscode') {
