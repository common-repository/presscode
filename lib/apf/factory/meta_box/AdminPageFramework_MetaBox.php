...
abstract class Pcode_AdminPageFramework_MetaBox_Router extends Pcode_AdminPageFramework_Factory {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'presscode') {
...
abstract class Pcode_AdminPageFramework_MetaBox_Model extends Pcode_AdminPageFramework_MetaBox_Router {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'presscode') {
    ...
    public function _replyToGetSavedFormData() {
        $_oMetaData = new Pcode_AdminPageFramework_MetaBox_Model___PostMeta($this->_getPostID(), $this->oForm->aFieldsets);
...
abstract class Pcode_AdminPageFramework_MetaBox_View extends Pcode_AdminPageFramework_MetaBox_Model {
...
abstract class Pcode_AdminPageFramework_MetaBox_Controller extends Pcode_AdminPageFramework_MetaBox_View {
...
abstract class Pcode_AdminPageFramework_MetaBox extends Pcode_AdminPageFramework_MetaBox_Controller {
