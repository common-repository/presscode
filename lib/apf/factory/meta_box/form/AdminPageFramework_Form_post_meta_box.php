...
class Pcode_AdminPageFramework_Form_post_meta_box extends Pcode_AdminPageFramework_Form_Meta {
    public $sStructureType = 'post_meta_box';
    public function construct() {
        $this->_addDefaultResources();
    }
    private function _addDefaultResources() {
        $_oCSS = new Pcode_AdminPageFramework_Form_View___CSS_meta_box;
