...
abstract class Pcode_AdminPageFramework_Model__FormSubmission_Base extends Pcode_AdminPageFramework_FrameworkUtility {
...
class Pcode_AdminPageFramework_Model__FormSubmission extends Pcode_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
    public function __construct($oFactory, $aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
        $this->oFactory = $oFactory;
        $this->_handleFormData();
        new Pcode_AdminPageFramework_Model__FormRedirectHandler($oFactory);
    }
    public function _handleFormData() {
        ...
        new Pcode_AdminPageFramework_Model__FormSubmission__Validator($this->oFactory);
