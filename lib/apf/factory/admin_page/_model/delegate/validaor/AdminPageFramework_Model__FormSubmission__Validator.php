...
class Pcode_AdminPageFramework_Model__FormSubmission__Validator_Base extends Pcode_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
...
class Pcode_AdminPageFramework_Model__FormSubmission__Validator extends Pcode_AdminPageFramework_Model__FormSubmission__Validator_Base {
    public $oFactory;
    ...
    public function _replyToValiateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
        ...
        $_aClassNames = array('Pcode_AdminPageFramework_Model__FormSubmission__Validator__Link', 'Pcode_AdminPageFramework_Model__FormSubmission__Validator__Redirect', 'Pcode_AdminPageFramework_Model__FormSubmission__Validator__Import', 'Pcode_AdminPageFramework_Model__FormSubmission__Validator__Export', 'Pcode_AdminPageFramework_Model__FormSubmission__Validator__Reset', 'Pcode_AdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'Pcode_AdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'Pcode_AdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm',);
        ...
        try {
            ...
            $_oFormSubmissionFilter = new Pcode_AdminPageFramework_Model__FormSubmission__Validator__Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);
