...
class Pcode_AdminPageFramework_Property_admin_page extends Pcode_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'presscode') {
        ...
        $GLOBALS['aPcode_AdminPageFramework']['aPageClasses'] = $this->getElementAsArray($GLOBALS, array('aPcode_AdminPageFramework', 'aPageClasses'));
        $GLOBALS['aPcode_AdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
