...
abstract class Pcode_AdminPageFramework_CustomSubmitFields extends Pcode_AdminPageFramework_FrameworkUtility {
    public $aPost = array();
    public $sInputID;
...
class Pcode_AdminPageFramework_ExportOptions extends Pcode_AdminPageFramework_CustomSubmitFields {
    public $sClassName;
    public $sFileName;
    public $sFormatType;
    public $bIsDataSet;
        ...
        switch (strtolower($sFormatType)) {
            case 'text':
                if (in_array(gettype($vData), array('array', 'object'))) {
                    echo Pcode_AdminPageFramework_Debug::get($vData, null, false);
                }
                echo $vData;
                return;
            case 'json':
