...
abstract class Pcode_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('Pcode_AdminPageFramework_RegisterClasses', false)) {
            return;
        }
        new Pcode_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
